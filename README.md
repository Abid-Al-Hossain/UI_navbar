# UI Foundry Navbar Studio

Standalone visual Navbar generator built with Next.js, React, and TypeScript.

Standalone Navbar component studio for building native, preview-honest, React-exportable UI patterns that match the UI Foundry product line.
...
- designers building Navbar UI quickly
- developers who need editable React starting points
- marketplace buyers who want a self-contained Navbar generator
...
The editor is focused on controls that are native to Navbar and useful in real product work:
- brand, nav links, active item, dropdown intent, action buttons, and mobile menu state
- layout direction, gap, density, sticky surface, background, border, shadow, and typography
- hover/focus/active link styling and state preview
- semantic nav labels and keyboard-safe link structure
- React export for navigation shell

The goal is maximum useful depth without adding unrelated controls that would make the component stop reading as Navbar.
...
This repo is intended to publish as Abid-Al-Hossain/UI_navbar.
